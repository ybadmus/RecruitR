...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create candidate' do
    assert_difference('Candidate.count') do
      post candidates_url,
           params: { candidate: { angelist: @candidate.angelist, email: @candidate.email, fname: @candidate.fname,
                                  linkedin: @candidate.linkedin, lname: @candidate.lname, position_id: @candidate.position_id } }
    end
